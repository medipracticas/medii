...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="https://adminlte.io/docs"><i class="fa fa-book"></i> <span>Medipracticas</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="compose.html" class="btn btn-primary btn-block margin-bottom">Modulos</a>
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="#"><i class="fa fa-inbox"></i> Anatofisiogia
                ...
                <li><a href="#"><i class="fa fa-file-text-o"></i> Farmacologia</a></li>
              </ul>
            </div>
            <!-- /.box-body -->
          </div>
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Modulos - Vista Completa</h3>
            ...
            <div class="box-body no-padding">
              <div class="table-responsive mailbox-messages">
                <table class="table table-striped">
                  ...
                  <tbody>
                  <tr>
                    <td>Fisiologia de la Conduccion</td>
                    <td>A.F Clinica </td>
                    <td>Complementos</td>
                    <td></td>
                  </tr>
                  ...
                  <tr>
                    <td>Fisiologia Neuromuscular</td>
                    <td>A.F Clinica </td>
                    <td>Complementos</td>
                    <td></td>
                  </tr>
                  <tr>
                    <td>Receptores y Sinapsis</td>
                    <td>A.F Clinica </td>
                    <td>Complementos</td>
                    <td></td>
                  </tr>
