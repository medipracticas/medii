    ...
    <section class="content">
      ...
      <div class="box box-default color-palette-box">
        <div class="box-header with-border">
          <h3 class="box-title"><i class="fa fa-tag"></i> Enfoques de estudio</h3>
        </div>
        <div class="box-body">
          <div class="row">
            <!-- /.col -->
            <div class="col-sm-4 col-md-2">
              <h4 class="text-center">Anatofisiologia</h4>
            ...
            <div class="col-sm-4 col-md-2">
              <h4 class="text-center">Clinica Patologica</h4>
            ...
            <div class="col-sm-4 col-md-2">
              <h4 class="text-center">Clinica Situacional</h4>
            ...
            <div class="col-sm-4 col-md-2">
              <h4 class="text-center">Clinica Sintomatologica</h4>
            ...
            <div class="col-sm-4 col-md-2">
              <h4 class="text-center">Clinica Casos medicos</h4>
